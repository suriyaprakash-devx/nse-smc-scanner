...
================================================================================
Feature Highlights:
- TOP 2000+ ACTIVE STOCKS SCANNING: Dedicated deterministic liquidity selector
  ranking by turnover to scan the top 2000+ most active NSE equities.
...
class UpstoxClient:
    ...
    def rank_top_active_equities(
        ...
        Uses cached daily statistics to deterministically sort.
        """
...
def evaluate_smc_setup(
    ...
    reason = (
        ...
        f"{trigger_displacement['timestamp'].strftime('%H:%M')}. "
